  ...
  handleSelect = address => {
    ...
    handleTestUpdateProfile = async () => {
      ...
      let userDocRef = await firestore
        .collection('users')
        .doc('yBwM4Pu0bEUmDMCs9BzSjnVDkMk2');
      try {
    ...
    handleTestJoinEvent = async () => {
      ...
      try {
        await eventDocRef.update({
          [`attendees.yBwM4Pu0bEUmDMCs9BzSjnVDkMk2`]: attendee
        });
        toastr.success('Success')
      } catch (error) {
        console.log(error);
    ...
    handleTestCancelGoingToEvent = async () => {
      ...
      try {
        await eventDocRef.update({
          [`attendees.yBwM4Pu0bEUmDMCs9BzSjnVDkMk2`]: firebase.firestore.FieldValue.delete()
        });
        toastr.success('Success')
      } catch (error) {
        console.log(error);
    ...
    handleTestChangeAttendeePhotoInEvent = async () => {
      ...
      try {
        await eventDocRef.update({
          [`attendees.yBwM4Pu0bEUmDMCs9BzSjnVDkMk2.photoURL`]: 'testing123.jpg'
        });
        toastr.success('Success')
      } catch (error) {
        console.log(error);
